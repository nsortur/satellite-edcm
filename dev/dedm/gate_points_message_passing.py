...
def test() -> None:
    ...
    import sys
    sys.path.append("/Users/neelsortur/Documents/codestuff/e3nn/e3nn/util/")
    import importlib
    import e3nn_test
    importlib.reload(e3nn_test)
    from e3nn_test import assert_equivariant, assert_auto_jitable
